...
Then both are also need to install bedtools related packages, it's recommended to refer to [here](https://bedtools.readthedocs.io/en/latest/content/installation.html).